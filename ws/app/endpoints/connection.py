...
def get_com_ports() -> None:
    ...
    socketio.emit("get_com_ports_result", {"success": True, "data": com_ports})
...
def connect_to_radio_link(connection_settings: ConnectionSettings) -> None:
    ...
    radio_link = RadioLink(port, baud)
    ...
    socketio.emit(
        ...
        {
            "success": True,
            "message": "Connected to radio link",
            "data": {"drones": radio_link.get_drones()},
        },
    )
